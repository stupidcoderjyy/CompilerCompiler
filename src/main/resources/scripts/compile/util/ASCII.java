...
public class ASCII {
    ...
    public static final int PUNCT   = 0x00001000;
    public static final int CNTRL   = 0x00002000;
    public static final int BLANK   = 0x00004000;
    public static final int HEX     = 0x00008000;
    public static final int UNDER   = 0x00010000;
    public static final int ASCII   = 0x0000FF00;
    //字母
    ...
    public static boolean isCtrl(int b) {
        return isType(b, CNTRL);
    }
}
